...
predictive target state (\textit{Soll}) with the interval-based current state
(\textit{Ist}) to reveal its potentials, and (iii)~derive recommendations for
