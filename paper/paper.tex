...
After-sales encompasses all post-purchase activities that help customers access supplier services and resolve product issue \cite{mertins_servitization_1999}. In the automotive context, it functions as a dedicated business module bundling maintenance, repair, and warranty offerings to maximise product use throughout the asset lifecycle while meeting financial and customer-performance targets \cite{sabbagha_impact_2016}. Building post-sales relationships strengthens customer loyalty, yields actionable insights, and creates upselling and cross-selling opportunities \cite{peters1997it}, making the automotive aftersales market increasingly attractive as demand for higher-quality service expands \cite{sabbagha_impact_2016}.

Verstrepen et al.~\cite{mertins_servitization_1999} observe that maintenance-free vehicles tend to disengage customers after warranty expiry and conclude that improved information systems and service processes are essential to retain them. The literature records a clear evolutionary shift in the automotive industry---from reactive, failure-based maintenance toward proactive and predictive strategies---driven by growing recognition that anticipating issues before they arise improves performance, efficiency, and long-term operational excellence \cite{pophaley_plant_2010}.
