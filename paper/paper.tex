...
After-sales encompasses all post-purchase activities---installation, repair, maintenance, quality control, and complaint handling---that help customers access supplier services and resolve product issues \cite{mertins_servitization_1999}. In the automotive context, it functions as a dedicated business module bundling maintenance, repair, and warranty offerings to maximise product use throughout the asset lifecycle while meeting financial and customer-performance targets \cite{sabbagha_impact_2016}. Building post-sales relationships strengthens customer loyalty, yields actionable insights, and creates upselling and cross-selling opportunities \cite{peters1997it}, making the automotive aftersales market increasingly attractive as demand for higher-quality service expands \cite{sabbagha_impact_2016}.

Historically, aftersales was predominantly \textit{reactive}: service was initiated only after a customer reported a failure, constraining both the timeliness and the breadth of interventions. Verstrepen et al.~\cite{mertins_servitization_1999} observe that maintenance-free vehicles tend to disengage customers after warranty expiry and conclude that improved information systems and service processes are essential to retain them. The literature records a clear evolutionary shift in the automotive industry---from reactive, failure-based maintenance toward proactive and predictive strategies---driven by growing recognition that anticipating issues before they arise improves performance, efficiency, and long-term operational excellence \cite{pophaley_plant_2010}.

The contemporary aftersales paradigm is therefore increasingly \textit{proactive}. Challagalla et al.~\cite{challagalla_proactive_2009} demonstrate that Proactive Post-Sales (PPS) service improves customer satisfaction and retention by enabling suppliers to identify and resolve issues before customers encounter them, yielding more productive interactions, broader customer reach, and greater innovation potential compared with the reactive approach. Proactive services must be tailored to customer needs and channel workload, necessitating tight integration of operational and informational data \cite{mertins_servitization_1999}. González-Prida et al.~\cite{gonzalez-pridaDigitalTransformationAftersales2025} provide a multiphase framework for deploying IoT, digital twins, and AI to this end, showing that machine learning and digital-twin-based approaches enable predictive interventions and better asset lifecycle optimisation, with concrete benefits including cost reduction, improved customer satisfaction, and extended asset lifetimes. Digital twins in particular allow maintenance to be grounded in current asset data, supporting precise, personalised interventions that extend operational lifetimes and improve service transparency \cite{gonzalez-pridaDigitalTransformationAftersales2025}. To ensure that AI-driven service decisions remain trustworthy, the OECD AI Principles require that aftersales systems be transparent, safe, explainable, and non-discriminatory, so that automated failure predictions and warranty decisions remain fair, auditable, and privacy-aware \cite{oecd2024ai}.
